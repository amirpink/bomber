...
"""+color.BLUE)
 print(f"{colorama.Fore.MAGENTA}creat by amirpink")
 print(f"{colorama.Fore.MAGENTA}rubika id : @amirpink")
 print(f"{colorama.Fore.MAGENTA}telegram id : @bombback")
 print(f"{colorama.Fore.RED}har yek payam 1 ta 8 payam ersal mikone")
 print(f"{colorama.Fore.MAGENTA}")
print(f"{colorama.Fore.RED}Waiting 2 sec ...")
time.sleep(1)
